...
Taking from the previous example, one can build a derivation like so:
...
includes: the executable binary, documentation, and locale info.
...
is a side-effect to achieve that goal.
