...
is commonly referred to as the derivation's "build closure". More dependencies that a
package refers to, more packages will need to be created in order to attempt a
...
their content. These derivations are easily differentiated because they
...
the process which fetches the assets.
